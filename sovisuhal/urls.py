...
urlpatterns = [
    ...
    path("structures_index/", view_cbv.StructuresIndexView.as_view(), name="structures index"),
    path("searchers_index/", view_cbv.SearchersIndexView.as_view(), name="searchers index"),
