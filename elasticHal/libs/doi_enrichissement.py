...
def docs_enrichissement_doi (docs):
    #Cette Fonction permet de retourner la date de mise en open access de l'ensembles des documents contenu dans doc en fonction de leur DOI
    ...
    #acces du document sinon initialise le date de mise en opend access vide
